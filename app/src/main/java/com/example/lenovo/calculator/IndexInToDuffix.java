...
public class IndexInToDuffix {
    public static Stack Houzhui(StringBuilder s)
    {
    ...
    public static String calc (Stack<String> stacka) throws Exception//计算逆波兰表达式
    {
        ...
        Log.d("text12",arr1.get(0).toString());
        return arr1.size()==1? arr1.get(0):"calculate failed";
